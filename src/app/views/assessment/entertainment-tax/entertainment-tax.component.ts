...
@Component({
  selector: "app-entertainment-tax",
  templateUrl: "./entertainment-tax.component.html",
  styleUrls: ["./entertainment-tax.component.scss"],
  animations: [SharedAnimations],
})
export class EntertainmentTaxComponent implements OnInit {
  private taxItem: any;
  private tax_item_id = 18;
  ...
  ngOnInit() {
    ...
    this.breadcrumb.setCrumbItem("entertainmentTax");
  ...
  saveAssessment() {
    ...
    if (this.taxForm.valid) {
      ...
      const amount = this.selfAssService.calculateEntertainmentTax(
      ...
      const display = JSON.stringify({
        start_tax_period: start_tax_period,
        end_tax_period: end_tax_period,
