...
@Component({
	...
	templateUrl: "./previous-LGC-Revenue-payments.component.html",
	styleUrls: ["./previous-LGC-Revenue-payments.component.scss"],
	animations: [SharedAnimations],
})
export class PreviousLGCRevenuePaymentsComponent implements OnInit {
	mdas: any;
	...
	loadAssessments() {
		...
		let url = "/Lgc_revenues/list?isPaid=true";
