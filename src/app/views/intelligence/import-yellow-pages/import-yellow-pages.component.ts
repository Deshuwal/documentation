...
@Component({
  selector: 'app-import-yellow-pages',
  templateUrl: './import-yellow-pages.component.html',
  styleUrls: ['./import-yellow-pages.component.scss'],
  animations: [SharedAnimations],
})
export class ImportYellowPagesComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.breadcrumb.setCrumbItem("intelligenceImportYellowPages");  
  }
