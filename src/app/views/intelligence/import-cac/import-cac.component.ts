...
@Component({
  selector: 'app-import-cac',
  templateUrl: './import-cac.component.html',
  styleUrls: ['./import-cac.component.scss'],
  animations: [SharedAnimations],
})
export class ImportCacComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.breadcrumb.setCrumbItem("intelligenceImportCac");  
  }
