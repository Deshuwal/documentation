...
@Component({
  selector: 'app-import-custom',
  templateUrl: './import-custom.component.html',
  styleUrls: ['./import-custom.component.scss'],
  animations: [SharedAnimations],
})
export class ImportCustomComponent implements OnInit {
  ...
  custom_data_list: any[] = [];
  selected_custom_data_category:any;
  ...
  ngOnInit() {
    ...
    this.breadcrumb.setCrumbItem("intelligenceImportCustom");  
  }
