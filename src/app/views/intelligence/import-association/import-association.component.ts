...
@Component({
  selector: 'app-import-association',
  templateUrl: './import-association.component.html',
  styleUrls: ['./import-association.component.scss'],
  animations: [SharedAnimations],
})
export class ImportAssociationComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.breadcrumb.setCrumbItem("intelligenceImportAssociation");  
  }
