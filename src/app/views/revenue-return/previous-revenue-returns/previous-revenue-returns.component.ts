...
@Component({
  ...
  templateUrl: "./previous-revenue-returns.component.html",
  styleUrls: ["./previous-revenue-returns.component.scss"],
  animations: [SharedAnimations],
})
export class PreviousRevenueReturnsComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.breadcrumb.setCrumbItem("previousIndividualRevenueReturn");
  ...
  loadAssessments() {
    ...
    let url = `/revenue_returns/get_revenue_returns_for_user?user_id=${this.userProfile.id}&role=${this.userProfile.role}`;
