...
@Component({
  ...
  templateUrl: "./previous-revenue-return-assessment.component.html",
  styleUrls: ["./previous-revenue-return-assessment.component.scss"],
  animations: [SharedAnimations],
})
export class PreviousRevenueReturnAssessmentComponent implements OnInit {
  mdas: any;
  ...
  loadAssessments() {
    ...
    if (this.userProfile.role == "1" || this.userProfile.role == "4") {
