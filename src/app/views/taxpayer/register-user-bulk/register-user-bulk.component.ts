...
@Component({
  selector: "app-register-user-bulk",
  templateUrl: "./register-user-bulk.component.html",
  styleUrls: ["./register-user-bulk.component.scss"],
  animations: [SharedAnimations],
})
export class RegisterUserBulkComponent implements OnInit {
